...
class RealTimeViolenceDetector:
    ...
    def predict_frames2(self, video_file_path=0):
        ...
        while video_reader.isOpened():
            ...
            # Display the frame with optional annotations
            display_frame = frame.copy()

            if violence_detected_info:
                cv2.putText(display_frame, "Violence Detected", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
    ...
    def predict_frames3(self, video_file_path=0):
        print("realtime")

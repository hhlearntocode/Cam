...
def detect_people(image_path, conf_threshold=0.5):
    ...
    for r in results[0].boxes:
        if (
            r.cls == 0 and r.conf >= conf_threshold
        ):  # Chỉ giữ lại các đối tượng là người
...
"""
HÀM THAY THẾ
file suppor_database.py

hàm: get_all_embedding()
trả về dict embedding[{user_id}]
"""
...
def getIDViolence(input_image):
    ...
    # from support_database import get_all_embedding

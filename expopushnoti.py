...
# Example usage:
push_token = "ExponentPushToken[oW86wKBSRKaCAap2lXarnR]"
message = "Phát hiện nguy hiểm!"
idUser = "xposrnwd4q2h69eyDKwN"

save_notification_with_image_to_firestore(idUser, message, "violence_frames/Violenceframe.jpg")
send_notification(idUser, message)

# send_push_notification(push_token, "Trường học", "Có dấu hiệu nguy hiểm đến con bạn")

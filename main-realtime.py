...
# database
from firebase import dbConnection, sendNotiToUsers
...
class ViolenceMonitor:
    ...
    def audio_thread(self):
        ...
        while not self.stop_event.is_set():
            ...
            detected_sound, scores, text, violence_keywords, violence_sound = (
                audio_processor.record_and_predict(duration=10, device_port=1)
            )
            ...
            audio_result = audio_processor.analyze_violence_rate(
                audio_elements["detected_sound"],
                audio_elements["scores"],
                audio_elements["text"],
            )
    ...
    def trigger_violence_alert(self, violence_weight, audio_data, video_data):
        ...
        if video_data:
            ...
            print(
                "  Final Violence Frame:",
                video_data.get("final_violence_frame_path", "N/A"),
            )

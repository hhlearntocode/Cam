        ...
        if(check1 != None):
            ...
            for i, v in enumerate(list_names):
                if list_distance[i] < 0.6:
                    ...
                    for curIdUser in idUser:
                        send_notification(curIdUser, message)
                    
            st.image("output_image.jpg")


    # =================================================================================================== # 
            # CODE WITH REALTIME VIDEO
    # =================================================================================================== # 

    # def handleRealtime():
    #     st.subheader("Realtime Prediction")
    #     st.write("Realtime prediction is not implemented yet.")

    # realtime = st.button("Realtime Prediction")
